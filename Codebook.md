...
## Raw data details
The raw data is from the Human Activity Recognition Using Smartphones Dataset- Version 1.0

The data can be sourced from: https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip 
...
For further information in relation to the project see: 
...
79 numeric fields for time and frequency domain signal variables 
